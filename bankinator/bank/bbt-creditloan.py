...
def navigate(homepage):
    ...
    _bank_session.get((_base_url + accounts[int(input_account)]['url']))
    ...
    cc_loan_table = _bank_session.get('https://online.bbt.com/olbsys/bbtolbext/bankcards/manageDetails',
